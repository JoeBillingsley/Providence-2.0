Feature: Estimating a deadline
  ...
  Scenario:
    Given a syntactically valid .arff file is at './src/test/resources/arff/org2.arff'
    ...
    And the evolution is run for 100 generations and the population have an anneal time of 25 generations
    ...
    Then the mean average LSD is less than 0.8120
    And the mean average MMRE is less than 1.6575
    And the mean average PRED25 is greater than 0.2633