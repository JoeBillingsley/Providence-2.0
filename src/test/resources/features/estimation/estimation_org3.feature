Feature: Estimating a deadline
  ...
  Scenario:
    Given a syntactically valid .arff file is at './src/test/resources/arff/org3.arff'
    ...
    Then the mean average LSD is less than 0.7076
    And the mean average MMRE is less than 0.9449
    And the mean average PRED25 is greater than 0.2909