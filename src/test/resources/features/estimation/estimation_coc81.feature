Feature: Estimating a deadline
  ...
  Scenario:
    Given a syntactically valid .arff file is at './src/test/resources/arff/coc81.arff'
    And the actual effort is contained in the feature 'actual'
    ...
    Then the mean average LSD is less than 1.9193
    And the mean average MMRE is less than 4.2374
    And the mean average PRED25 is greater than 0.1600