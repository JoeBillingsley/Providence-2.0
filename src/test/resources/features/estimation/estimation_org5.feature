Feature: Estimating a deadline
  ...
  Scenario:
    Given a syntactically valid .arff file is at './src/test/resources/arff/org5.arff'
    ...
    Then the mean average LSD is less than 6.4777
    And the mean average MMRE is less than 5.4348
    And the mean average PRED25 is greater than 0.2033