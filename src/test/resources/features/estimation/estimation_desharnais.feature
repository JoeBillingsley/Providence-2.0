Feature: Estimating a deadline
  ...
  Scenario:
    Given a syntactically valid .arff file is at './src/test/resources/arff/desharnais.arff'
    ...
    Then the mean average LSD is less than 1.1515
    And the mean average MMRE is less than 0.4701
    And the mean average PRED25 is greater than 0.4200