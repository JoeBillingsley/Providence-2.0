Feature: Estimating a deadline
  ...
  Scenario:
    Given a syntactically valid .arff file is at './src/test/resources/arff/org7.arff'
    ...
    Then the mean average LSD is less than 2.1753
    And the mean average MMRE is less than 4.3080
    And the mean average PRED25 is greater than 0.1633