...
public class GraphSeries extends VBox {
    ...
    /**
     * Adds data to a series that has already been constructed in {@link controller.custom_controls.GraphSeries#addSeries(String)}.
     *
     ...
     *               For example if 3 metrics have been defined using {@link controller.custom_controls.GraphSeries#addMetrics(List)}
