Feature: Estimating a deadline
  ...
  Scenario:
    Given a syntactically valid .arff file is at './src/test/resources/arff/org1.arff'
    ...
    Then the mean average LSD is less than 1.1560
    And the mean average MMRE is less than 0.8739
    And the mean average PRED25 is greater than 0.2967