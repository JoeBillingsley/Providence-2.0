Feature: Estimating a deadline
  ...
  Scenario:
    Given a syntactically valid .arff file is at './src/test/resources/arff/cocomo-sdr.arff'
    And the actual effort is contained in the feature ''ACTUAL EFFORT''
    ...
    Then the mean average LSD is less than 2.0944
    And the mean average MMRE is less than 8.6331
    And the mean average PRED25 is greater than 0.0833