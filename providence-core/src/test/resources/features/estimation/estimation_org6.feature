Feature: Estimating a deadline
  ...
  Scenario:
    Given a syntactically valid .arff file is at './src/test/resources/arff/org6.arff'
    ...
    Then the mean average LSD is less than 1.4703
    And the mean average MMRE is less than 1.1507
    And the mean average PRED25 is greater than 0.1833