Feature: Estimating a deadline
  ...
  Scenario:
    Given a syntactically valid .arff file is at './src/test/resources/arff/nasa.arff'
    ...
    Then the mean average LSD is less than 1.4005
    And the mean average MMRE is less than 1.1140
    And the mean average PRED25 is greater than 0.3200